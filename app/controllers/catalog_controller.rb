...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_search_field 'booster pack', label: 'Booster Pack' do |field|
      field.qt = 'search'
      field.solr_parameters = {
        qf: 'boosters_tesim',
        pf: 'boosters_tesim'
    ...
    config.add_component_indexed_terms_field 'booster_packs', field: 'boosters_ssm', link_to_facet: true, component: Arcdex::BoosterPackComponent
